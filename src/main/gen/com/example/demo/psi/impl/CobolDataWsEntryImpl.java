...
public class CobolDataWsEntryImpl extends ASTWrapperPsiElement implements CobolDataWsEntry {

  public CobolDataWsEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitDataWsEntry(this);
  }
