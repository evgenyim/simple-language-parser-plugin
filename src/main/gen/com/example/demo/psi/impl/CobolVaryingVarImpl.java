...
public class CobolVaryingVarImpl extends ASTWrapperPsiElement implements CobolVaryingVar {

  public CobolVaryingVarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitVaryingVar(this);
  }
