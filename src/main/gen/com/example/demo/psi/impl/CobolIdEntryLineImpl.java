...
public class CobolIdEntryLineImpl extends ASTWrapperPsiElement implements CobolIdEntryLine {

  public CobolIdEntryLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitIdEntryLine(this);
  }
